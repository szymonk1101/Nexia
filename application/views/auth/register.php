...
<head>
    ...
    <title>Nexia - Załóż nowe konto</title>
...
<body>
                            ...
                            <div class="slick-slider slick-initialized">
                                <div>
                                    <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-premium-dark" tabindex="-1">
                                        <div class="slide-img-bg" style="background-image: url('<?= base_url('web/assets/images/originals/citynights.jpg'); ?>');"></div>
    ...
    <script type="text/javascript" src="<?= base_url('web/assets/js/scripts/main.8d288f825d8dffbbe55e.js'); ?>"></script>
</body>
</html>
