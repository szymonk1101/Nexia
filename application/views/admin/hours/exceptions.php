                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>
                                    Wyjątki w godzinach dostępności
...
var exceptions_datatable_ajax_url = '<?= base_url('admin/hours/getExceptionsDataTable'); ?>';
...
JavascriptManager::add(array(
    ...
    'web/admin/scripts/views/hours_exceptions.js'
)); 
?>
