                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            ...
                            <div class="page-title-actions">
                                <a href="<?= base_url('admin/breaks/add'); ?>">
                            ...
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">   
                                    <div class="card-body">
                                        ...
                                        <table style="width:100%" id="breaks_datatable" class="table table-hover table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                                    <th>Pracownik</th>
...
var breaks_datatable_ajax_url = '<?= base_url('admin/breaks/getBreaksDataTable'); ?>';
...
JavascriptManager::add(array(
    ...
    'web/admin/scripts/views/breaks_index.js'
)); 
?>
